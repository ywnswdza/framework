...
import org.losy.utils.ReadPropertiesUtil;
import org.losy.utils.StringUtils;
import org.losy.utils.TemplateUtils;
...
public class CodeGenerator {
	...
	static {
		TemplateUtils.initTempConfig("/ftl");
	}
	...
	public static void generatorAll(List<TableInfo> tableInfos){
		...
		for (TableInfo tableInfo : tableInfos) {
			...
			if(ReadPropertiesUtil.getBooleanValue("gen.sql")) {
				...
				m.put("outPath", outputRootPath + File.separator + "src" + File.separator + "main" + File.separator + "resources" + File.separator + "mapper");
				...
				m.put("fileName", tableInfo.getEntitySimpleName() + "SqlMapper.xml");
			...
			if(ReadPropertiesUtil.getBooleanValue("gen.domian")) {
				m.put("outPath", outputRootPath + File.separator + "src" + File.separator +  "main" + File.separator +  "java" + File.separator +
						packagePrefix.replaceAll("\\.", "\\\\") + File.separator + projectName + File.separator + "entity");
			...
			if(ReadPropertiesUtil.getBooleanValue("gen.dao")) {
				m.put("outPath", outputRootPath + File.separator + "src" + File.separator + "main" + File.separator +  "java" + File.separator +
						packagePrefix.replaceAll("\\.", "\\\\") + File.separator + projectName + File.separator + "dao");
				m.put("fileName","I" + tableInfo.getEntitySimpleName() + "Mapper.java");
			...
			if(ReadPropertiesUtil.getBooleanValue("gen.service")) {
				m.put("outPath", outputRootPath + File.separator + "src" + File.separator + "main" + File.separator +  "java" + File.separator +
						packagePrefix.replaceAll("\\.", "\\\\") + File.separator + projectName + File.separator + "service");
			...
			if(ReadPropertiesUtil.getBooleanValue("gen.controller")) {
				m.put("outPath", outputRootPath  + File.separator + "src"+File.separator + "main" + File.separator +  "java" + File.separator +
						packagePrefix.replaceAll("\\.", "\\\\") + File.separator + projectName + File.separator + "controller");
